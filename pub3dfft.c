...
int pubdz3d(int isign, int n1, int n2, int n3, float *w, int ld1, int ld2, float *table, int ntable, float *work) {

  //called by: pubdz3d(1, data->dims[2], data->dims[1], data->dims[0], q_arr, data->dims[4], data->dims[3], data->fft_table, data->fft_ntable, data->fft_work);
  ...
  n1over2 = n1 / 2;
  ld1over2 = ld1 / 2;
  rval = pubz3d(&isign, &n1over2, &n2, &n3, (floatcomplex*) w, &ld1over2, &ld2, table, &ntable, (floatcomplex*) work);
...
int pubzd3d(int isign, int n1, int n2, int n3, float *w, int ld1, int ld2, float *table, int ntable, float *work) {

  //called by:
  //pubzd3d(-1, data->dims[2], data->dims[1], data->dims[0], q_arr, data->dims[4], data->dims[3], data->fft_table, data->fft_ntable, data->fft_work);
